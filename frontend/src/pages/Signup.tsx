...
export default function Signup() {
  ...
  const onSubmit = async (values: Form) => {
    try {
      ...
      alert(getApiError(e, "Signup failed"));
    }
  };

  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 px-4">
      <div className="max-w-md w-full bg-white/90 backdrop-blur-sm border border-gray-200 p-8 rounded-2xl shadow-2xl shadow-gray-200/50">
        {/* Header Section */}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="group">
            ...
            <div className="relative">
              <input 
                className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 pl-11 text-gray-800 placeholder-gray-400 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all duration-200 outline-none group-hover:border-gray-300" 
